...
const assetsDir =
	'C:/Users/Aman/.cursor/projects/c-Users-Aman-rusthacks/assets';
...
const USER_SCREENSHOTS = [
	{
		...
		file: 'dota2-esp-player-tags.webp',
	},
	{
		source:
		...
		file: 'dota2-wallhack-skeleton.webp',
	},
	{
		source:
	...
	},
	{
		...
		file: 'dota2-aimbot-skeleton.webp',
	},
	{
		source:
...
const REMOVE_PREFIXES = [
	...
	'dota2-cheats-aimbot',
	'dota2-cheats-cover',
	'dota2-cheats-esp-wallhack',
	'dota2-cheats-hero',
	'dota2-cheats-logo',
	'dota2-cheats-package',
	'rust-header-art',
...
async function generateResponsiveVariants() {
	const heroSource = path.join(imagesDir, 'dota2-esp-player-tags.webp');
	const heroMeta = await sharp(heroSource).metadata();

	for (const width of HERO_WIDTHS) {
		if (heroMeta.width && width > heroMeta.width) continue;
		const file = `dota2-esp-player-tags-${width}w.webp`;
	...
	for (const { file } of USER_SCREENSHOTS) {
		if (file === 'dota2-esp-player-tags.webp') continue;
...
async function generateFavicons() {
	const logoPath = path.join(imagesDir, 'dota2-cheats-logo.png');
