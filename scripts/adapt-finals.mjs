...
const RENAME_PAGE_DIRS = [
	...
	['reliable-rust-cheats', 'reliable-finals-cheats'],
...
const REPLACEMENTS = [
	...
	['buy-reliable-rust-cheats-windows-pc', 'buy-reliable-finals-cheats-windows-pc'],
	...
	['Rust Hacks', 'Dota 2 Hacks'],
	['Rust Features', 'Dota 2 Features'],
	['Rust Status', 'Dota 2 Status'],
	['Rust patches', 'Dota 2 patches'],
	['Rust updates', 'Dota 2 updates'],
	['Rust setup', 'Dota 2 setup'],
	['Rust license', 'Dota 2 license'],
	['Rust licenses', 'Dota 2 licenses'],
	['in Rust', 'in Dota 2'],
	['for Rust', 'for Dota 2'],
	['Rust on', 'Dota 2 on'],
	['Rust or', 'Dota 2 or'],
...
async function updatePageAstroFiles() {
	const idMap = {
		...
		'reliable-finals-cheats': 'reliable',
