...
import { buildOverlaySvg } from './dota2-cheat-overlays.mjs';

const imagesDir = path.resolve('public/images');
const publicDir = path.resolve('public');

/** Verified IGN Dota 2 screenshot CDN paths. */
...
/**
 * dota 2 cheats image pipeline:
 * 1. Download real Dota 2 gameplay from IGN
 * 2. Composite ESP / aimbot / radar / mod-menu overlays for dota 2 cheats marketing
 */
const KEYWORD_ASSETS = [
	{
		file: 'dota2-cheats-hero.webp',
		url: `${ME_G}/the-dota2-screenshots_wjkx.1400.jpg`,
		overlay: 'hero',
	},
	{
		file: 'dota2-cheats-aimbot.webp',
		url: `${ME}/the-dota2-screenshots_wjb1.1400.jpg`,
		overlay: 'aimbot',
	},
	{
		file: 'dota2-cheats-esp-wallhack.webp',
		url: `${ME}/the-dota2-screenshots_55fp.1400.jpg`,
		overlay: 'wallhack',
	},
	{
		file: 'rust-pack-fight.webp',
		url: `${ME}/the-dota2-screenshots_67cp.1400.jpg`,
		overlay: 'esp',
	},
	{
		file: 'dota2-cheats-package.webp',
		url: `${ME}/the-dota2-screenshots_anf4.1400.jpg`,
		overlay: 'menu',
	},
	{
		file: 'dota2-cheats-cover.webp',
		url: `${ME}/the-dota2-screenshots_7pr8.1400.jpg`,
		overlay: 'esp',
	},
	{
		file: 'rust-header-art.webp',
		url: `${ME}/the-dota2-screenshots_c36j.1400.jpg`,
		overlay: 'hero',
	},
	{
		file: 'rust-loadout-builder.webp',
		url: `${NL}/the-dota2-screenshots_e5gw.1400.jpg`,
		overlay: 'menu',
	},
	{
		file: 'rust-survival-combat.webp',
		url: `${ME}/the-dota2-screenshots_4h92.1400.jpg`,
		overlay: 'esp',
	},
	{
	...
	},
	{
		...
		url: `${ME}/the-dota2-screenshots_rb92.1400.jpg`,
		overlay: 'esp',
	},
	{
...
async function cleanImagesDir() {
	...
	for (const file of files) {
		if (file.includes('dota2-cheats-logo')) continue;
...
async function generateBrandAssets(heroBuffer) {
	...
	await writeFile(path.join(imagesDir, 'dota2-cheats-logo.webp'), logoBuffer);
...
for (const asset of KEYWORD_ASSETS) {
	...
	try {
		...
		saved++;
		if (asset.file === 'dota2-cheats-hero.webp') heroBuffer = webp;
	} catch (err) {
...
console.log(`\nDone — ${saved}/${KEYWORD_ASSETS.length} dota 2 cheats images (IGN base + ESP/aimbot overlays).`);
