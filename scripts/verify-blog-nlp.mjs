#!/usr/bin/env node
import { blogPosts } from '../src/data/forums/posts.generated.ts';
...
const needles = ['${EXT', 'V-Bucks', 'Hammer AR', 'FNCS', 'the map', 'EliteFN', 'GhostWare', 'CheatSpike', 'Battle Pass', 'Item Shop'];
