...
export const PAGE_META_HOME = {
	es: { title: 'Dota 2 Cheats 2026 | ESP, Wallhack y Aimbot', desc: 'Trucos Dota 2 para Dota 2 en PC. ESP wallhack, radar hack y Aimbot con mantenimiento VAC. Entrega digital instantánea.', h1: 'cheats para Dota 2', intro: 'Paquete para Dota 2 en Windows PC: ESP wallhack, radar y Aimbot con mantenimiento VAC tras cada parche.', imageAlt: 'Dota 2 ESP — etiquetas de jugador hack', gallery: 'Galería Dota 2 Cheats — ESP, Aimbot y wallhack', cta2: 'Ver funciones', h2a: 'Por qué eligen Dota 2 Cheats en 2026', h2b: 'ESP wallhack, radar y Aimbot en una licencia', topicA: 'Ideal para leer héroes enemigos en Ranked y casual matches.', topicB: 'Una licencia en lugar de herramientas separadas.' },
	fr: { title: 'Dota 2 Cheats 2026 | ESP, Wallhack et Aimbot', desc: 'Triches Dota 2 pour Dota 2 sur PC. ESP wallhack, radar hack et Aimbot avec maintenance VAC. Livraison numérique instantanée.', h1: 'triches pour Dota 2', intro: 'Pack pour Dota 2 sur PC Windows : ESP wallhack, radar et Aimbot avec maintenance VAC après chaque patch.', imageAlt: 'Dota 2 ESP — tags joueur hack', gallery: 'Galerie Dota 2 Cheats — ESP, Aimbot et wallhack', cta2: 'Voir les fonctions', h2a: 'Pourquoi choisir Dota 2 Cheats en 2026', h2b: 'ESP wallhack, radar et Aimbot en une licence', topicA: 'Parfait pour lire les héros ennemis en Ranked et casual matches.', topicB: 'Une licence au lieu d\'outils séparés.' },
	de: { title: 'Dota 2 Cheats 2026 | ESP, Wallhack & Aimbot', desc: 'dota 2 cheats für Dota 2 auf PC. ESP Wallhack, Radar Hack und Aimbot mit VAC-Wartung. Sofortige digitale Lieferung.', h1: 'dota 2 cheats für Dota 2', intro: 'Windows PC Paket für Dota 2: ESP Wallhack, Radar und Aimbot mit VAC-Wartung nach jedem Patch.', imageAlt: 'Dota 2 ESP — Spieler-Tags Hack', gallery: 'Dota 2 Cheats Galerie — ESP, Aimbot und Wallhack', cta2: 'Features ansehen', h2a: 'Warum Dota 2 Cheats 2026 führt', h2b: 'ESP Wallhack, Radar und Aimbot in einer Lizenz', topicA: 'Ideal um feindliche heroes in ranked und ranked matches zu lesen.', topicB: 'Eine Lizenz statt separater Tools.' },
	pt: { title: 'Dota 2 Cheats 2026 | ESP, Wallhack e Aimbot', desc: 'Cheats Dota 2 premium para Dota 2 no PC. ESP wallhack, radar hack e Aimbot com manutenção VAC. Entrega digital instantánea.', h1: 'cheats premium para Dota 2', intro: 'Pacote para Dota 2 no Windows PC: ESP wallhack, radar e Aimbot com manutenção VAC após cada patch.', imageAlt: 'Dota 2 ESP player tags hack', gallery: 'Galeria Dota 2 Cheats — ESP, Aimbot e wallhack', cta2: 'Ver recursos', h2a: 'Por que escolher Dota 2 Cheats em 2026', h2b: 'ESP wallhack, radar e Aimbot numa licença', topicA: 'Ideal para ler heróis inimigos em BR e ranked matches.', topicB: 'Uma licença em vez de ferramentas separadas.' },
	it: { title: 'Dota 2 Cheats 2026 | ESP, Wallhack e Aimbot', desc: 'Cheat Dota 2 per Dota 2 su PC. ESP wallhack, radar hack e Aimbot con manutenzione VAC. Consegna digitale istantanea.', h1: 'cheat per Dota 2', intro: 'Pacchetto per Dota 2 su PC Windows: ESP wallhack, radar e Aimbot con manutenzione VAC dopo ogni patch.', imageAlt: 'Dota 2 ESP player tags hack', gallery: 'Galleria Dota 2 Cheats — ESP, Aimbot e wallhack', cta2: 'Vedi funzioni', h2a: 'Perché scegliere Dota 2 Cheats nel 2026', h2b: 'ESP wallhack, radar e Aimbot in una licenza', topicA: 'Ideale per leggere herore nemiche in ranked e ranked matches.', topicB: 'Una licenza invece di tool separati.' },
	nl: { title: 'Dota 2 Cheats 2026 | ESP, Wallhack & Aimbot', desc: 'dota 2 cheats voor Dota 2 op PC. ESP wallhack, radar hack en Aimbot met VAC-onderhoud. Directe digitale levering.', h1: 'dota 2 cheats voor Dota 2', intro: 'Windows PC pakket voor Dota 2: ESP wallhack, radar en Aimbot met VAC-onderhoud na elke patch.', imageAlt: 'Dota 2 ESP player tags hack', gallery: 'Dota 2 Cheats galerij — ESP, Aimbot en wallhack', cta2: 'Bekijk functies', h2a: 'Waarom Dota 2 Cheats in 2026', h2b: 'ESP wallhack, radar en Aimbot in één licentie', topicA: 'Ideaal om vijandelijke heroes te lezen in ranked en ranked matches.', topicB: 'Eén licentie in plaats van losse tools.' },
	pl: { title: 'Dota 2 Cheats 2026 | ESP, Wallhack i Aimbot', desc: 'cheaty Dota 2 dla Dota 2 na PC. ESP wallhack, radar hack i Aimbot z konserwacją VAC. Natychmiastowa dostawa cyfrowa.', h1: 'cheaty dla Dota 2', intro: 'pakiet premium dla Dota 2 na Windows PC: ESP wallhack, radar i Aimbot z konserwacją VAC po każdym patchu.', imageAlt: 'Dota 2 ESP player tags hack', gallery: 'Galeria Dota 2 Cheats — ESP, Aimbot i wallhack', cta2: 'Zobacz funkcje', h2a: 'Dlaczego Dota 2 Cheats w 2026', h2b: 'ESP wallhack, radar i Aimbot w jednej licencji', topicA: 'Idealny do czytania wrogich heroów w BR i ranked matches.', topicB: 'Jedna licencja zamiast osobnych narzędzi.' },
	ru: { title: 'Dota 2 Cheats 2026 | ESP, Wallhack и Aimbot', desc: 'читы Dota 2 для Dota 2 на PC. ESP wallhack, radar hack и Aimbot с обслуживанием VAC. Мгновенная цифровая доставка.', h1: 'читы для Dota 2', intro: 'пакет для Dota 2 на Windows PC: ESP wallhack, radar и Aimbot с обслуживанием VAC после патчей.', imageAlt: 'Dota 2 ESP — теги игроков hack', gallery: 'Галерея Dota 2 Cheats — ESP, Aimbot и wallhack', cta2: 'Смотреть функции', h2a: 'Почему выбирают Dota 2 Cheats в 2026', h2b: 'ESP wallhack, radar и Aimbot в одной лицензии', topicA: 'Идеально для чтения вражеских отрядов в BR и ranked matches.', topicB: 'Одна лицензия вместо отдельных инструментов.' },
	tr: { title: 'Dota 2 Cheats 2026 | ESP, Wallhack ve Aimbot', desc: 'Dota 2 için hileler. ESP wallhack, radar hack ve Aimbot — VAC bakımı. Anında dijital teslimat.', h1: 'Dota 2 için hileler', intro: 'Dota 2 Windows PC Premium-Paketi: ESP wallhack, radar ve Aimbot — VAC bakımı dahil.', imageAlt: 'Dota 2 ESP player tags hack', gallery: 'Dota 2 Cheats galeri — ESP, Aimbot ve wallhack', cta2: 'Özellikleri gör', h2a: '2026\'da neden Dota 2 Cheats', h2b: 'ESP wallhack, radar ve Aimbot tek lisans', topicA: 'Ranked ve casual matches\'da düşman hero okumak için ideal.', topicB: 'Ayrı araçlar yerine tek lisans.' },
	ar: { title: 'Dota 2 Cheats 2026 | ESP وWallhack وAimbot', desc: 'غش Dota 2 لـ Dota 2 على PC. ESP wallhack ورadar hack وAimbot مع صيانة VAC. تسليم رقمي فوري.', h1: 'غش احترافي لـ Dota 2', intro: 'حزمة لـ Dota 2 على Windows PC: ESP wallhack ورadar وAimbot مع صيانة VAC.', imageAlt: 'Dota 2 ESP player tags hack', gallery: 'معرض Dota 2 Cheats — ESP وAimbot وwallhack', cta2: 'عرض الميزات', h2a: 'لماذا Dota 2 Cheats في 2026', h2b: 'ESP wallhack ورadar وAimbot في ترخيص واحد', topicA: 'مثالي لقراءة فرق العدو في BR وranked matches.', topicB: 'ترخيص واحد بدلاً من أدوات منفصلة.' },
	ja: { title: 'Dota 2 Cheats 2026 | ESP・Wallhack・Aimbot', desc: 'Dota 2向けpremiumチート。ESP wallhack、radar hack、Aimbot、VACメンテナンス。即時デジタル配信。', h1: 'Dota 2向けpremiumチート', intro: 'Dota 2 Windows PC向けpremiumパッケージ：ESP wallhack、radar、Aimbot、VACメンテナンス付き。', imageAlt: 'dota 2 cheats hero ESP aimbot wallhack', gallery: 'Dota 2 Cheatsギャラリー — ESP、Aimbot、wallhack', cta2: '機能を見る', h2a: '2026年にDota 2 Cheatsを選ぶ理由', h2b: 'ESP wallhack、radar、Aimbotが1ライセンス', topicA: 'BRとranked matchesで敵スクワッドを読むのに最適。', topicB: '別ツールではなく1ライセンス。' },
	ko: { title: 'Dota 2 Cheats 2026 | ESP, Wallhack, Aimbot', desc: 'Dota 2 치트. ESP wallhack, radar hack, Aimbot, VAC 유지보수. 즉시 디지털 배송.', h1: 'Dota 2용 치트', intro: 'Dota 2 Windows PC 패키지: ESP wallhack, radar, Aimbot, VAC 유지보수 포함.', imageAlt: 'dota 2 cheats hero ESP aimbot wallhack', gallery: 'Dota 2 Cheats 갤러리 — ESP, Aimbot, wallhack', cta2: '기능 보기', h2a: '2026년 Dota 2 Cheats를 선택하는 이유', h2b: 'ESP wallhack, radar, Aimbot 단일 라이선스', topicA: 'BR 및 ranked matches에서 적 분대 읽기에 이상적.', topicB: '별도 도구 대신 단일 라이선스.' },
	zh: { title: 'Dota 2 Cheats 2026 | ESP、Wallhack、Aimbot', desc: 'Dota 2作弊。ESP wallhack、radar hack、Aimbot、VAC维护。即时数字交付。', h1: 'Dota 2的premium外挂', intro: 'Dota 2 Windows PC套餐：ESP wallhack、radar、Aimbot，含VAC维护。', imageAlt: 'dota 2 cheats hero ESP aimbot wallhack', gallery: 'Dota 2 Cheats图库 — ESP、Aimbot、wallhack', cta2: '查看功能', h2a: '2026年选择Dota 2 Cheats的原因', h2b: 'ESP wallhack、radar、Aimbot单一许可证', topicA: '适合在BR和ranked matches中读取敌方小队。', topicB: '一个许可证而非多个工具。' },
	hi: { title: 'Dota 2 Cheats 2026 | ESP, Wallhack और Aimbot', desc: 'Dota 2 hacks. ESP wallhack, radar hack, Aimbot, VAC maintenance. Instant digital delivery.', h1: 'Dota 2 ke liye dota 2 cheats', intro: 'Dota 2 Windows PC पैकेज: ESP wallhack, radar, Aimbot, VAC maintenance सहित.', imageAlt: 'dota 2 cheats hero ESP aimbot wallhack', gallery: 'Dota 2 Cheats gallery — ESP, Aimbot, wallhack', cta2: 'फ़ीचर्स देखें', h2a: '2026 में Dota 2 Cheats क्यों', h2b: 'ESP wallhack, radar, Aimbot एक लाइसेंस में', topicA: 'BR और ranked matches में दुश्मन hero पढ़ने के लिए आदर्श.', topicB: 'अलग टूल्स के बजाय एक लाइसेंस.' },
	id: { title: 'Dota 2 Cheats 2026 | ESP, Wallhack & Aimbot', desc: 'Dota 2 Cheats untuk Dota 2 di PC. ESP wallhack, radar hack, Aimbot, pemeliharaan VAC. Pengiriman digital instan.', h1: 'cheat untuk Dota 2', intro: 'Premium-Paket Dota 2 di Windows PC: ESP wallhack, radar, Aimbot dengan pemeliharaan VAC.', imageAlt: 'Dota 2 ESP player tags hack', gallery: 'Galeri Dota 2 Cheats — ESP, Aimbot, wallhack', cta2: 'Lihat fitur', h2a: 'Mengapa Dota 2 Cheats di 2026', h2b: 'ESP wallhack, radar, Aimbot dalam satu lisensi', topicA: 'Ideal membaca hero musuh di BR dan ranked matches.', topicB: 'Satu lisensi alih-alih alat terpisah.' },
	th: { title: 'Dota 2 Cheats 2026 | ESP, Wallhack และ Aimbot', desc: 'Dota 2 Cheats สำหรับ Dota 2 บน PC. ESP wallhack, radar hack, Aimbot, VAC maintenance. จัดส่งดิจิทัลทันที.', h1: 'cheat สำหรับ Dota 2', intro: 'แพ็ก สำหรับ Dota 2 บน Windows PC: ESP wallhack, radar, Aimbot พร้อม VAC maintenance', imageAlt: 'Dota 2 ESP player tags hack', gallery: 'แกลเลอรี Dota 2 Cheats — ESP, Aimbot, wallhack', cta2: 'ดูฟีเจอร์', h2a: 'ทำไมเลือก Dota 2 Cheats ปี 2026', h2b: 'ESP wallhack, radar, Aimbot ในใบอนุญาตเดียว', topicA: 'เหมาะสำหรับอ่าน hero ศัตรูใน BR และ ranked matches', topicB: 'ใบอนุญาตเดียวแทนเครื่องมือแยก' },
	vi: { title: 'Dota 2 Cheats 2026 | ESP, Wallhack & Aimbot', desc: 'Dota 2 Cheats cho Dota 2 trên PC. ESP wallhack, radar hack, Aimbot, bảo trì VAC. Giao hàng kỹ thuật số tức thì.', h1: 'cheat cho Dota 2', intro: 'Gói premium Dota 2 trên Windows PC: ESP wallhack, radar, Aimbot với bảo trì VAC.', imageAlt: 'Dota 2 ESP player tags hack', gallery: 'Thư viện Dota 2 Cheats — ESP, Aimbot, wallhack', cta2: 'Xem tính năng', h2a: 'Vì sao chọn Dota 2 Cheats 2026', h2b: 'ESP wallhack, radar, Aimbot trong một giấy phép', topicA: 'Lý tưởng đọc hero địch trong BR và ranked matches.', topicB: 'Một giấy phép thay vì công cụ riêng.' },
	uk: { title: 'Dota 2 Cheats 2026 | ESP, Wallhack і Aimbot', desc: 'чіти Dota 2 для Dota 2 на PC. ESP wallhack, radar hack, Aimbot, обслуговування VAC. Мгновенная цифровая доставка.', h1: 'чіти для Dota 2', intro: 'пакет для Dota 2 на Windows PC: ESP wallhack, radar, Aimbot з обслуговуванням VAC.', imageAlt: 'Dota 2 ESP player tags hack', gallery: 'Галерея Dota 2 Cheats — ESP, Aimbot, wallhack', cta2: 'Дивитися функції', h2a: 'Чому Dota 2 Cheats у 2026', h2b: 'ESP wallhack, radar і Aimbot в одній ліцензії', topicA: 'Ідеально для читання ворожих загонів у BR і ranked matches.', topicB: 'Одна ліцензія замість окремих інструментів.' },
	cs: { title: 'Dota 2 Cheats 2026 | ESP, Wallhack a Aimbot', desc: 'dota 2 cheaty pro Dota 2 na PC. ESP wallhack, radar hack, Aimbot, údržba VAC. Okamžité digitální doručení.', h1: 'cheaty pro Dota 2', intro: 'balíček pro Dota 2 na Windows PC: ESP wallhack, radar, Aimbot s údržbou VAC.', imageAlt: 'Dota 2 ESP player tags hack', gallery: 'Galerie Dota 2 Cheats — ESP, Aimbot, wallhack', cta2: 'Zobrazit funkce', h2a: 'Proč Dota 2 Cheats v roce 2026', h2b: 'ESP wallhack, radar a Aimbot v jedné licenci', topicA: 'Ideální pro čtení nepřátelských heroů v BR a ranked matches.', topicB: 'Jedna licence místo samostatných nástrojů.' },
	ro: { title: 'Dota 2 Cheats 2026 | ESP, Wallhack și Aimbot', desc: 'Dota 2 Cheats pentru Dota 2 pe PC. ESP wallhack, radar hack, Aimbot, mentenanță VAC. Livrare digitală instantă.', h1: 'cheat-uri pentru Dota 2', intro: 'pachet premium Dota 2 pe Windows PC: ESP wallhack, radar, Aimbot cu mentenanță VAC.', imageAlt: 'Dota 2 ESP player tags hack', gallery: 'Galerie Dota 2 Cheats — ESP, Aimbot, wallhack', cta2: 'Vezi funcții', h2a: 'De ce Dota 2 Cheats în 2026', h2b: 'ESP wallhack, radar și Aimbot într-o licență', topicA: 'Ideal pentru citirea hero-urilor inamice în BR și ranked matches.', topicB: 'O licență în loc de instrumente separate.' },
	sv: { title: 'Dota 2 Cheats 2026 | ESP, Wallhack & Aimbot', desc: 'dota 2 cheats för Dota 2 på PC. ESP wallhack, radar hack, Aimbot, VAC-underhåll. Omedelbar digital leverans.', h1: 'dota 2 cheats för Dota 2', intro: 'Premium-Paket för Dota 2 på Windows PC: ESP wallhack, radar, Aimbot med VAC-underhåll.', imageAlt: 'Dota 2 ESP player tags hack', gallery: 'Dota 2 Cheats galleri — ESP, Aimbot, wallhack', cta2: 'Se funktioner', h2a: 'Varför Dota 2 Cheats 2026', h2b: 'ESP wallhack, radar och Aimbot i en licens', topicA: 'Ideal för att läsa fiendeheroes i BR och ranked matches.', topicB: 'En licens istället för separata verktyg.' },
};
...
export const PAGE_META_TAILS = {
	'dota2-esp': { suffix: 'Player Boxes & Wallhack', focus: 'player boxes, hero markers, and wallhack overlays', altKeyword: 'ESP wallhack overlay' },
	'dota2-aimbot': { suffix: 'Skillshot assist Controls', focus: 'Skillshot assist, FOV, and per-weapon Aimbot profiles', altKeyword: 'aimbot combat' },
	features: { suffix: 'Full Feature List', focus: 'ESP, Skillshot assist, radar controls', altKeyword: 'cheats package ESP aimbot' },
	...
	faq: { suffix: 'Common Answers', focus: 'ESP, Skillshot assist, delivery, and VAC questions', altKeyword: 'FAQ ESP aimbot' },
	support: { suffix: 'Help & Contact', focus: 'order help and license support contact', altKeyword: 'support license help' },
	reliable: { suffix: 'VAC Safe Status', focus: 'maintenance after VAC patches', altKeyword: 'dota 2 cheats ESP' },
	wallhack: { suffix: 'ESP Visibility', focus: 'wallhack ESP for players, wards and runes, and distance', altKeyword: 'wallhack ESP visibility' },
	...
	'mod-menu': { suffix: 'In-Game Toggles', focus: 'in-client ESP and Skillshot assist toggles', altKeyword: 'mod menu ESP aimbot' },
	'soft-aim': { suffix: 'Smooth Aim Settings', focus: 'smooth Skillshot assist settings for Windows PC', altKeyword: 'Skillshot assist aimbot' },
	'best-cheats': { suffix: 'Buyer Checklist', focus: 'what to compare before buying dota 2 cheats', altKeyword: 'best hacks ESP aimbot' },
	'aimbot-hack': { suffix: 'Skillshot assist Assist', focus: 'Aimbot hack assist for Dota 2', altKeyword: 'aimbot hack combat' },
	'esp-hack': { suffix: 'Boxes & wards and runes', focus: 'ESP hack boxes, wards and runes pins, and distance', altKeyword: 'ESP hack wallhack' },
...
export const SUFFIX_I18N = {
	es: {
		...
		'dota2-aimbot': 'Controles Skillshot assist',
		...
		'soft-aim': 'Ajustes Skillshot assist',
		'best-cheats': 'Lista de compra',
		'aimbot-hack': 'Asistencia Skillshot assist',
		'esp-hack': 'Cajas y wards and runes',
		'unlock-all': 'Qué significa',
	},
	fr: {
		'dota2-esp': 'Boîtes joueur et wallhack',
		'dota2-aimbot': 'Contrôles Skillshot assist',
		...
		'soft-aim': 'Réglages Skillshot assist',
		'best-cheats': 'Checklist acheteur',
		'aimbot-hack': 'Assistance Skillshot assist',
		'esp-hack': 'Boîtes et wards and runes',
	...
	de: {
		...
		'esp-hack': 'Boxen & wards and runes',
	...
	pt: {
		...
		'aimbot-hack': 'Assistência Skillshot assist',
		'esp-hack': 'Caixas e wards and runes',
		'unlock-all': 'O que significa',
	},
	it: {
		'dota2-esp': 'Box giocatore e wallhack',
		'dota2-aimbot': 'Controlli Skillshot assist',
		...
		'soft-aim': 'Impostazioni Skillshot assist',
		'best-cheats': 'Checklist acquirente',
		'aimbot-hack': 'Assist Skillshot assist',
		'esp-hack': 'Box e wards and runes',
		'unlock-all': 'Cosa significa',
	},
	ru: {
		'dota2-esp': 'Боксы игроков и wallhack',
		'dota2-aimbot': 'Управление Skillshot assist',
		...
		'soft-aim': 'Настройки Skillshot assist',
		'best-cheats': 'Чеклист покупателя',
		'aimbot-hack': 'Skillshot assist ассист',
	...
	return {
		...
		description: clampDesc(
			stripcheckoutFromMeta(
				`${topicName} for Dota 2 ranked and casual matches on Windows PC — ${focus}. ${p.delivery}. ${p.premium}. Official dota 2 cheats at dota2cheat.com.`,
			),
		),
		h1: topicName,
...
export const TOPIC_NAMES = {
	...
	reliable: { en: 'dota 2 cheats', es: 'Trucos Dota 2', fr: 'Triches Dota 2', de: 'dota 2 cheats', pt: 'cheats Dota 2', it: 'Cheat Dota 2', nl: 'dota 2 cheats', pl: 'Cheaty Dota 2', ru: 'читы Dota 2', tr: 'Dota 2 hileleri', ar: 'غش Dota 2', ja: 'Dota 2チート', ko: 'Dota 2 치트', zh: 'Dota 2作弊', hi: 'dota 2 cheats', id: 'Cheat Dota 2', th: 'ชีต Dota 2', vi: 'Cheat Dota 2', uk: 'чіти Dota 2', cs: 'cheaty Dota 2', ro: 'Cheats Dota 2', sv: 'dota 2 cheats' },
	...
	'soft-aim': { en: 'Dota 2 Skillshot assist', es: 'Skillshot assist Dota 2', fr: 'Skillshot assist Dota 2', de: 'Dota 2 Skillshot assist', pt: 'Skillshot assist Dota 2', it: 'Skillshot assist Dota 2', nl: 'Dota 2 Skillshot assist', pl: 'Skillshot assist Dota 2', ru: 'Skillshot assist Dota 2', tr: 'Dota 2 Skillshot assist', ar: 'Skillshot assist Dota 2', ja: 'Dota 2 Skillshot assist', ko: 'Dota 2 Skillshot assist', zh: 'Dota 2 Skillshot assist', hi: 'Dota 2 Skillshot assist', id: 'Skillshot assist Dota 2', th: 'Dota 2 Skillshot assist', vi: 'Skillshot assist Dota 2', uk: 'Skillshot assist Dota 2', cs: 'Dota 2 Skillshot assist', ro: 'Skillshot assist Dota 2', sv: 'Dota 2 Skillshot assist' },
	...
	return {
		...
		sections: [
			...
			section(
				...
				kind === 'terms'
					? L?.terms?.sec2p2 ?? 'Using cheats may violate Valve terms — you assume all ban risk.'
					: p.s3(),
			),
