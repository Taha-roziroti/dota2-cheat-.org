...
export const enPages = {
	...
	'dota2-esp': {
		...
		ctaPrimary: 'Buy Dota 2 Cheats',
		ctaSecondary: 'dota 2 wallhack guide',
		...
		sections: [
			...
			section(
				...
				'ESP alone wins information wars; Aimbot covers the competitive fight. Review <a href="/dota2-aimbot/">Aimbot controls</a> if you want one license for visibility and assist.',
				'Compare monthly ($35) and lifetime ($150) on <a href="/pricing/">Pricing</a>, then keep <a href="/support/">Support</a> ready if activation needs a human reply.',
				'Still researching? The <a href="/dota2-cheats/">Dota 2 Cheats pillar</a> and <a href="/dota2-cheats-2026/">2026 buyer guide</a> summarize the full stack.',
			),
			section(
				'Agent ESP, skeleton overlays, and threat awareness',
				'Beyond basic player boxes, Dota 2 Cheats ESP supports operator ability markers, distance tags, and configurable skeleton-style outlines for ranked matches reads. Toggle categories so souljade contests, third-party fights, and flank routes stay readable without screen clutter.',
				'Pair ESP with <a href="/dota2-radar-hack/">2D radar</a> for off-screen threats during zone pushes. Map-specific awareness (high-traffic POIs and vertical loadout drop routes) matters as much as raw wallhack range.',
	...
	'dota2-aimbot': {
		...
		sections: [
			section(
				'Aimbot tuned for Dota 2 combat pace',
				'Dota 2 mixes long-range mid-size competitive fights with close-quarters ambush rushes. Dota 2 Cheats Aimbot includes smoothness, FOV, and aim smoothing controls tuned for that pace — with hotkey toggles mid-match.',
				...
				`Weapon balance and season rules change via ${EXT.dota2}. Revisit Aimbot FOV and smoothness after major combat patches so assist still matches the live TTK windows.`,
			),
			section(
	...
	features: {
		...
		description:
			'Full dota 2 cheats feature list — aimbot sliders, player ESP, bots ESP, item ESP, radar, color options, and config profiles for PC. See every control at dota2cheat.com.',
		h1: 'Dota 2 Cheats Features — Full Control List',
		intro:
			'Every aimbot, player ESP, bots ESP, item ESP, radar, color, key bind, and config option included in Dota 2 Cheats for Dota 2 on Windows PC — with VAC maintenance after major patches.',
		...
		sections: [
			...
			section(
				'Bots ESP features',
				'Bots ESP adds health bars with adjustable thickness and custom position for AI targets in mixed lobbies. Useful when bot lobbies or mixed player counts appear during off-peak sessions.',
				'Health overlays help you prioritize real players over AI during warm-up phases and mixed ranked matches queues on PC.',
				[
					'Health',
					'Health Thickness Slider',
					'Custom Health Position',
				],
			),
			section(
				'Items ESP options',
			...
			section(
				'Color options',
				'Custom color pickers for every overlay category — aimbot crosshair, FOV circle, target highlight, player distance, nicknames, visible and non-visible states, bots, and radar enemies.',
				'Separate colors for visible vs non-visible players make it easy to know when you can shoot through smoke or hard cover in ranked matches fights.',
				[
			...
			section(
				'Custom key binds',
				'Rebind menu, hold, toggle, and head-switch keys without alt-tabbing. Separate binds for players, bots, radar, and items keep mid-match control fast.',
				'Quick toggles let you disable item ESP during final circles or enable radar only when rotating across open ground.',
				[
			...
			section(
				'Config options',
				'Save multiple config profiles for different maps or play styles. Create, name, and switch configs from the in-game menu without restarting the loader.',
				'Profiles let you store separate aimbot and ESP settings for the map, Urzikstan, and Rebirth Island.',
				[
					'Select Your Custom Config',
					'Create New Config Name',
					'Add New Config',
				],
			),
			section(
				'Related guides and checkout',
				'Deep-dive individual modules on the <a href="/dota2-esp/">ESP page</a>, <a href="/dota2-aimbot/">aimbot page</a>, and <a href="/dota2-radar-hack/">radar hack page</a>.',
				'Monthly ($35) and lifetime ($150) licenses include every feature above with VAC maintenance on the <a href="/updates/">Updates page</a>. Compare plans on <a href="/pricing/">Pricing</a>.',
			),
		],
	},
	pricing: {
		title: 'Dota 2 Cheats Pricing | $35/mo or $150 Lifetime',
		description:
	...
	setup: {
		...
		galleryTitle: 'Dota 2 Cheats setup visuals',
		ctaPrimary: 'Buy Dota 2 Cheats',
	...
	faq: {
		...
		sections: [
			...
			section(
				...
				'Contact support@dota2cheat.com or the <a href="/support/">Support page</a> with order details for setup or billing help. First launch steps are on <a href="/setup/">Setup</a>.',
	...
	support: {
		...
		h1: 'Dota 2 Cheats Support — Contact Us',
		intro:
			'Get help with Dota 2 Cheats licenses, checkout, ESP wallhack setup, Aimbot profiles, and VAC maintenance for Dota 2 on Windows PC.',
		imageAlt: "Dota 2 Cheats support page for license and setup help",
		galleryTitle: 'Dota 2 Cheats support resources',
		...
		sections: [
			section(
				...
				'Reach out for order issues, license activation failures, ESP wallhack or Aimbot setup questions, and post-patch problems after VAC maintenance rebuilds.',
			...
			section(
				...
				'Setup guide, Features list, Updates log, Refund Policy, and Terms of Use are linked from the footer. VAC bypass notes live on the dedicated <a href="/vac-bypass/">VAC bypass page</a>.',
	...
	reliable: {
		...
		sections: [
			...
			section(
				...
				'When VAC or Dota 2 updates ship, the team assesses ESP, radar, and Aimbot modules, publishes status on the <a href="/updates/">Updates page</a>, and delivers rebuilt builds to active licenses.',
				`On patch mornings, also check ${EXT.status} for launcher outages that can look like product failures.`,
				'Deep technical workflow: <a href="/vac-bypass/">VAC bypass Dota 2 guide</a>. Feature stack: <a href="/features/">Features</a>.',
			),
			section(
	...
	radar: {
		...
		galleryTitle: 'dota2 radar hack visuals',
		ctaPrimary: 'Buy Dota 2 Cheats',
		ctaSecondary: 'See ESP wallhack',
		ctaSecondaryHref: '/dota2-esp/',
		sections: [
	...
	'vac': {
		...
		description:
			'Dota 2 vac bypass explained — how ESP, aimbot & radar rebuild after VAC patches on PC. HWID risk, maintenance workflow & status at dota2cheat.com.',
		h1: 'VAC Bypass — Dota 2 Cheats Maintenance',
		intro:
			'Understand VAC maintenance for Dota 2 Cheats — how ESP wallhack, radar hack, and Aimbot rebuild after Dota 2 security updates.',
		imageAlt: "Dota 2 Cheats maintenance after a VAC patch",
		galleryTitle: 'VAC maintenance visuals',
		ctaPrimary: 'Buy Dota 2 Cheats',
	...
	hacks: {
		...
		sections: [
			...
			section(
				'Getting started',
				'After checkout, follow the <a href="/setup/">Setup guide</a> to activate your license and load default ESP and aim profiles. Keep your order ID ready for support at support@dota2cheat.com.',
				'New buyers should also read the <a href="/forums/dota2-cheats-complete-guide-2026/">2026 complete guide</a> and <a href="/forums/dota2-cheats-buyers-guide/">buyers guide</a> before comparing shops.',
				'Ready to buy? Open <a href="/pricing/">Pricing</a> or return to the <a href="/">homepage</a> for the latest status summary.',
			),
			section(
				'Why search “dota 2 cheats” and “dota 2 cheats” together',
				'Players use both terms interchangeably. This pillar targets dota 2 cheats intent while linking to <a href="/">dota 2 cheats</a> on the homepage. Feature depth lives on <a href="/dota2-esp/">ESP</a>, <a href="/dota2-aimbot/">aimbot</a>, and <a href="/dota2-radar-hack/">radar</a> pages.',
				'For 2026 seasonal buyers, open <a href="/dota2-cheats-2026/">dota 2 cheats 2026</a> and <a href="/">dota 2 cheats</a> checklists before comparing budget shops on <a href="/compare/">Compare</a>.',
				'Honest comparisons: <a href="/forums/dota2-cheats-vs-cheatspike-comparison/">vs budget shops</a> · <a href="/forums/dota2-cheats-vs-ghostware-features-pricing/">vs ESP-only tools</a>.',
			),
		],
	},
	'cheat-download': {
		...
		galleryTitle: 'dota 2 cheat download visuals',
		ctaPrimary: 'Buy Dota 2 Cheats',
	...
	'mod-menu': {
		...
		galleryTitle: 'Dota 2 mod menu gallery',
		ctaPrimary: 'Buy Dota 2 Cheats',
		...
		sections: [
			...
			section(
				...
				'Dota 2 mod menu behavior is rebuilt when VAC or major Dota 2 updates land. Follow the <a href="/updates/">Updates page</a> and <a href="/vac-bypass/">VAC bypass guide</a> before loading in on patch days.',
	...
	'unlock-all': {
		...
		galleryTitle: 'Dota 2 unlock-all guide visuals',
		ctaPrimary: 'Buy Dota 2 Cheats',
	...
	privacy: {
		...
		description:
			'Privacy policy for Dota 2 Cheats at dota2cheat.com. How we handle support emails, order data & checkout for dota 2 cheats licenses on PC.',
		h1: 'Privacy Policy',
		...
		sections: [
			...
			section(
				...
				'Analytics may use aggregated traffic data without identifying individual Dota 2 Cheats customers.',
			),
			section(
	...
	refund: {
		...
		description:
			'Refund policy for Dota 2 Cheats at dota2cheat.com. Eligibility, delivery terms & how to request a refund for ESP, aimbot & radar licenses.',
		h1: 'Refund Policy',
		intro:
			'Refund terms for Dota 2 Cheats licenses — ESP wallhack, radar hack, and Aimbot packages purchased through checkout for Dota 2.',
		imageAlt: "Dota 2 Cheats refund policy page",
		galleryTitle: 'Dota 2 Cheats billing resources',
		...
		sections: [
			section(
				...
				'Dota 2 Cheats licenses deliver digitally after payment confirmation. Because access begins immediately, refunds are limited to cases outlined below.',
			...
			section(
				'Chargebacks and EU consumer rights',
			...
			section(
				'Partial refunds and processing time',
	...
	terms: {
		...
		description:
			'Terms of use for dota2cheat.com & Dota 2 Cheats licenses. Usage rules, VAC risk disclaimer & liability for PC dota 2 cheats.',
		h1: 'Terms of Use',
		...
		sections: [
			section(
				...
				'By purchasing or using Dota 2 Cheats you agree to these terms. Licenses grant personal use of ESP wallhack, radar, and Aimbot tools for Dota 2 on Windows PC only.',
