/** IGN source URLs per game — synced to /public/images/guides/ via sync-guide-images.mjs */
export const IGN_SOURCE_IMAGES = {
...
export function guideImagePath(game) {
	return `/images/guides/${gameSlug(game)}.webp`;
}
