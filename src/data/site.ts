...
export const seoLandingPages = [
	...
	{ label: fillBrandTokens('{game} cheats'), href: '/warzone-cheats/' },
	...
	{ label: fillBrandTokens('Best {primaryKeyword}'), href: '/best-warzone-cheats/' },
	{ label: fillBrandTokens('{antiCheat} bypass'), href: '/ricochet-bypass/' },
...
export const footerExplore = [
	...
	{ label: fillBrandTokens('{game} cheats pillar'), href: '/warzone-cheats/' },
