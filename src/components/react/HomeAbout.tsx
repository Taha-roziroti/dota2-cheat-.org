		...
		<section className="shell home__prose home__prose--en" aria-labelledby="home-about-title">
			<div className="home__prose-callout">
				...
				<p>
					...
					<a href="/dota2-cheats/">{t('home.aboutPillar')}</a>
					{t('home.aboutP2Mid')}
					<a href="/dota2-esp/">{t('home.aboutEsp')}</a>
					{t('home.aboutP2Mid')}
					<a href="/dota2-aimbot/">{t('home.aboutAimbot')}</a>
					{t('home.aboutP2Or')}
					<a href="/updates/">{t('home.aboutReliable')}</a>
					{t('home.aboutP2After')}
				</p>
			</div>
		</section>
